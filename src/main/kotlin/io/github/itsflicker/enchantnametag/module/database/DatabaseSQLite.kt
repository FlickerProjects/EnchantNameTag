...
class DatabaseSQLite : Database() {
    ...
    val host = File(EnchantNameTag.conf.getString("Database.SQLite.file")!!.replace("{plugin_folder}", getDataFolder().absolutePath)).getHost()

    val table = Table(EnchantNameTag.conf.getString("Database.SQLite.table")!!, host) {
        add {
            name("user")
